...
- Arch Linux:
  - [Latest Version 0.3.15](https://github.com/nbfc-linux/nbfc-linux/releases/download/0.3.15/nbfc-linux-git-0.3.14.r10.g662957a-1-x86_64.pkg.tar.zst)
  - Install curl: `pacman -S curl`
  - Install NBFC-Linux: `pacman -U ./nbfc-linux-git-0.3.14.r10.g662957a-1-x86_64.pkg.tar.zst`
  - Or via AUR (`yay -S nbfc-linux`)
  - Or by using the PKGBUILD [nbfc-linux-git](pkgbuilds/nbfc-linux-git/PKGBUILD)

- Debian / Ubuntu:
  - [Latest Version 0.3.15](https://github.com/nbfc-linux/nbfc-linux/releases/download/0.3.15/nbfc-linux_0.3.15_amd64.deb)
  - Install libcurl: `apt install libcurl4`
  - Install NBFC-Linux: `dpkg -i ./nbfc-linux_0.3.15_amd64.deb`

- Fedora:
  - [Latest Version 0.3.15](https://github.com/nbfc-linux/nbfc-linux/releases/download/0.3.15/fedora-nbfc-linux-0.3.15-1.x86_64.rpm)
  - Install libcurl: `dnf install libcurl`
  - Install NBFC-Linux: `dnf install ./fedora-nbfc-linux-0.3.15-1.x86_64.rpm`

- OpenSuse (Tumbleweed)
  - [Latest Version 0.3.15](https://github.com/nbfc-linux/nbfc-linux/releases/download/0.3.15/opensuse-nbfc-linux-0.3.15-1.x86_64.rpm)
  - Install libcurl: `zypper install libcurl4`
  - Install NBFC-Linux: `zypper install ./opensuse-nbfc-linux-0.3.15-1.x86_64.rpm`
