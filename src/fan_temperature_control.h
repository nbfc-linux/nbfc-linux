...
Error* FanTemperatureControl_SetDefaults(FanTemperatureControl*, int);
Error* FanTemperatureControl_SetByConfig(array_of(FanTemperatureControl)*, array_of(FanTemperatureSourceConfig)*, ModelConfig*);
